function Get-VMByAddress {
    ...
    param (
        ...
        [parameter(Mandatory=$true,ParameterSetName="FindByIPWildcard")][string]$AddressWildcard
    ) ## end param
